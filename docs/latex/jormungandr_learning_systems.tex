...
choices.  Structured behavior-cloning checkpoints initialize the compatible
...
count, episode length, and reward sparsity before GAE, so a critic fitting one
common outcome is not mistaken for a policy receiving useful return diversity.
...
rates are zero.  It does not validate the Kagriculture reward, joint-action
trajectory, variable representation, or opponent protocol; those remain
separate gates.
...
PPO, reward-free weighted structured supervision, direct BC-to-PPO policy
...
deviation, minimum, maximum, unique-value count, mean episode length, and
nonzero-reward fraction before GAE.  This is a diagnostic distinction: high
...
The recorded functional suite contains 92 passing cases.  It includes direct
...
isolation, semantic candidate permutation, BC-to-PPO initialization, the seeded
